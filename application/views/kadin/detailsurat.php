        ...
        <div class="container-fluid">
          ...
          <?php foreach ($pengesahan as $ps) {
            $id_kp = $ps['id_kp'];
            $no_pas = $ps['no_pas'];
            $tgl_terbit = $ps['tgl_terbit'];
            $tgl_kadaluwarsa = $ps['tgl_kadaluwarsa'];
            $penerbit = $ps['penerbit'];
            $asal_ktp = $ps['asal_ktp'];
            $nik = $ps['nik'];
            $nama_kapal = $ps['nama_kapal'];
            $tanda_selar = $ps['tanda_selar'];
            $jenis_alat = $ps['jenis_alat'];
            $berat = $ps['berat'];
            $muatan = $ps['muatan'];
            $kekuatan = $ps['kekuatan'];
            $merk_mesin = $ps['merk_mesin'];
            $no_mesin = $ps['no_mesin'];
            $bahan = $ps['bahan'];
            $penangkapan = $ps['penangkapan'];
            $pangkalan = $ps['pangkalan'];
            $anak_buah = $ps['anak_buah'];
            $upload_ktp = $ps['upload_ktp'];
            $upload_pas = $ps['upload_pas'];
            $upload_kapal_datang = $ps['upload_kapal_datang'];
            $status = $ps['status'];
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Verifikasi Pendaftaran Perizinan Kapal</h1>
...
<div class="modal fade" id="newSubMenuModal" tabindex="-1" role="dialog" aria-labelledby="newMenuModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="newSubMenuModalLabel">Tambah Nomor Surat</h5>
        <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button> -->
      </div>
