...
--
-- Host: localhost
-- Waktu pembuatan: 26 Jun 2020 pada 16.46
...
(19, '1234567998', 'Kota Pekalongan', '12546584165213', '2020-06-24', '2020-06-24', 'Dishub Tegal', 'Mekar sejati', '21', 'jaring_angkat', 2, 21, 120, 'Cargo', '123456', 'fiber', 'Kota Pekalongan', 'Kota Pekalongan', 4, '2006240652071.jpg', '200624065207.jpg', '200624065207.png', 'menunggu');
...
INSERT INTO `tb_surat` (`id_surat`, `id_kp`, `no_surat`, `tgl_terbit`, `tgl_kadaluwarsa`, `catatan`) VALUES
(11, 0, '028/SPKPI/DKP/IV/2019', '2020-01-02', '2020-01-02', '-'),
(12, 0, '029/SPKPI/DKP/IV/2019', '2020-01-02', '2020-01-02', '-'),
(13, 0, '028/SPKPI/DKP/IV/2019', '2020-01-05', '2020-01-05', '-'),
(14, 0, '029/SPKPI/DKP/IV/2019', '2020-01-05', '2020-01-05', '-'),
...
(30, 'Coba Test', 'wawanbatang93@gmail.com', 'default.png', '$2y$10$jEIxuWNDPVo.rL1LHJRAZOiZ4.hRUdhPHginEUZGqRL4XgmdD04D2', 2, 1, 1577781999);
...
(17, 7, 'Dashboard', 'home', 'fas fa-fw fa-tachometer-alt', 1);
...
--
ALTER TABLE `tb_kapal`
  MODIFY `id_kp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
